...
function Foo(props: FooProps) {
	...
	return (
		<Box>
			...
			<Button variant='contained' sx={{ margin: 1 }} onClick={changeName}>Change Name</Button>
			<Button variant='contained' sx={{ margin: 1 }} onClick={moveUp}>move up</Button>
			<Button variant='contained' sx={{ margin: 1 }} onClick={moveDown}>move down</Button>
		</Box>
	);
}
